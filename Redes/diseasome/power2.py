...
def get_ordered_nodes(G):
	...
	return sorted_nodes #[[id do no ,e betweenes]...]
...
if len(sys.argv) == 2:
	G = algo2(G, G.number_of_nodes() - 1, int(sys.argv[2]))
elif len(sys.argv) == 3:
	G = algo2(G, G.number_of_nodes() - 1, int(sys.argv[2]), sys.argv[3])
else:
